...
def seed(db_path):
    ...
    db.save_device_metrics(db_path, "firewall", fws[0]["id"], {
        ...
        "vpn": {"tunnel_total": 12, "tunnel_up": 10, "ssl_users": 23,
                "tunnels": []},
        "policy": {"total": 412, "unused": 37, "disabled": 9},
    ...
    db.save_device_metrics(db_path, "firewall", fws[1]["id"], {
        ...
        "level": "critical",
        "vpn": {"tunnel_total": 8, "tunnel_up": 6, "ssl_users": 4, "tunnels": []},
        "policy": {"total": 380, "unused": 51, "disabled": 2},
